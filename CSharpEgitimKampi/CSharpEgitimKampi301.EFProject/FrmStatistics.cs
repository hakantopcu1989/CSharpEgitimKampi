...
namespace CSharpEgitimKampi301.EFProject
{
    public partial class FrmStatistics : Form
    {
        ...
        private void FrmStatistics_Load(object sender, EventArgs e)
        {
            ...
            //lblAvarageLocationPrice.Text=db.Location.Average(x=>x.Price).ToString();
            lblAvarageLocationPrice.Text = db.Location.Average(x => x.Price).GetValueOrDefault()
    .ToString("N2", CultureInfo.GetCultureInfo("tr-TR")) + " ₺";
...
//https://www.youtube.com/watch?v=VoFQi8dVj14&list=PLKnjBHu2xXNPmFMvGKVHA_ijjrgUyNIXr&index=18