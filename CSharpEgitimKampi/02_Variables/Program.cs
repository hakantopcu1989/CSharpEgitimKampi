...
namespace _02_Variables
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //double strawberyyTotalPrice = strawberryGram * strawberryPrice;
            ...
            //Console.WriteLine("Alınan Ürün: Çilek - " + "Birim Fiyat: " +strawberryPrice+ " - Gramaj: " +strawberryGram+ " - Toplam Tutar: " +strawberyyTotalPrice+ " TL");
            ...
            //double shoppingTotalPrice = appleTotalPrice + orangeTotalPrice + strawberyyTotalPrice + potatoTotalPrice + tomatoTotalPrice;
            ...
            //Console.WriteLine();
            //Console.WriteLine("----------------------");
            //Console.WriteLine("Yolcu Kimlik No: "+passangerIdentityNumber+" "+ "Yolcu Adı Soyadı: "+ passangerName+" "+passangerSurname+" "+passangerDistrict+" "+passangerCity+" "+passangerAge);
            ...
            //Console.WriteLine();
            //Console.WriteLine("Toplam Sınav Ortalamanız: "  +result);
